package nurulhakiki.polbeng.ac.id.jasaonline.helpers
...
class SessionHandler {
    ...
    fun saveUser(user: User) {
        ...
        mEditor!!.putString(KEY_TANGGAL_LAHIR, user.tanggal_lahir)
        mEditor!!.putString(KEY_JENIS_KELAMIN, user.jenis_kelamin)
        mEditor!!.putString(KEY_NOMOR_HP, user.nomor_hp)
...
//Check if user is logged in first
        ...
        user.tanggal_lahir = mPreferences!!.getString(KEY_TANGGAL_LAHIR,
            KEY_EMPTY)
        user.jenis_kelamin = mPreferences!!.getString(KEY_JENIS_KELAMIN,
            KEY_EMPTY)
        user.nomor_hp = mPreferences!!.getString(KEY_NOMOR_HP, KEY_EMPTY)
