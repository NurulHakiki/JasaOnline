package nurulhakiki.polbeng.ac.id.jasaonline.fragments
...
import nurulhakiki.polbeng.ac.id.jasaonline.activities.EditProfileActivity
import nurulhakiki.polbeng.ac.id.jasaonline.activities.LoginActivity
...
import nurulhakiki.polbeng.ac.id.jasaonline.services.UserService
...
// Inflate the layout for this fragment
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(user != null) {
            ...
            view.tvTanggalLahir.text = titikDua + user.tanggal_lahir
            view.tvJenisKelamin.text = titikDua + user.jenis_kelamin
            view.tvNomorHP.text = titikDua + user.nomor_hp
